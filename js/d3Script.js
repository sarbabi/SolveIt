				...
				svg.append("defs")
                    ...
                    .attr('height', h)
                   	.append("image")
                    .attr("xlink:href", "images/bg2.jpg")
                    .attr('width', w)
                    .attr('height', h);
				...
				var lblCur = svg.append("text").attr("x", w-62)
								.attr("y", 25)
								.text("-")
				...
				var lblOBest = svg.append("text").attr("x", w-60)
								.attr("y", 130)
								.text("-")
								.attr("font-family", "Artifika")
				                .attr("font-size", "13px")
				...
				var lblRank = svg.append("text").attr("x", w-60)
								.attr("y", 155)
								.text("-")
								.attr("font-family", "Artifika")
				                .attr("font-size", "13px")
...
*/
				...
				var lblexit = svg.append("text").attr("x", w-145)
								.attr("y", 210)
								.text("SAVE & EXIT")
								.attr("font-family", "Artifika")
				                .attr("font-size", "13px")
  ...
  // the return value is assigned to QueryString!
	...
	console.log(lvl);
				...
				d3.csv("data_files/"+lvl+".csv", function(d){
											draggableCirclesData=d;
											ldfix();
											});

				/*d3.csv("fixedPoints.csv", function(d){
											fixedCirclesData=d;
											populateFixedCircles(fixedCirclesData);
										});*/
				var fcd=[];
				var ldfix = function(){$.post('cInit.php',{level: lvl},
					function(data){
						//console.log(data);
				...
				var dcd=[];
				var ldmov = function(){$.post('fInit.php',{level: lvl},
					function(data){
						//console.log(data);
						if(data == "0"){
							console.log("salam finit retured 0");
							...
							console.log("salam finit didnt return 0");
							var values = data.split(",");
